...
function selectTheme(theme) {
  ...
  const themeColors = {
    default: {
      primary: "#ffffff",
      primaryDark: "#e5e5e5",
      gradient: "linear-gradient(180deg, #000000 0%, #121212 100%)",
    },
    pink: { primary: "#ff1168", primaryDark: "#ff2d7a", gradient: "linear-gradient(180deg, #4a1c3a 0%, #121212 100%)" },
    blue: { primary: "#1e3264", primaryDark: "#2d4a96", gradient: "linear-gradient(180deg, #1e3264 0%, #121212 100%)" },
    green: {
      primary: "#1db954",
      primaryDark: "#1ed760",
      gradient: "linear-gradient(180deg,rgb(3, 56, 19) 0%, #121212 100%)",
    },
    purple: {
      primary: "#8b5cf6",
      primaryDark: "#a78bfa",
      gradient: "linear-gradient(180deg, #4c1d95 0%, #121212 100%)",
    },
    orange: {
      primary: "#f97316",
      primaryDark: "#fb923c",
      gradient: "linear-gradient(180deg,rgb(110, 62, 7) 0%, #121212 100%)",
    },
  }
